        ...
        <div class="row">
          <div class="col">
            <div class="form-group">  
             <div class="input-box ">
               <input type="text"  name="title" id="title" placeholder="destination" class="form-control col-md-11">
            ...
            <div class="card text-center card-product">
                <div class="card-product__img" >
                    @foreach (explode(',', $trip->image) as $image)
                        <img class="card-img" src="{{ asset('/'.$image) }}" alt="IMG-PRODUCT">
                        @break
                    @endforeach
                    <ul class="card-product__imgOverlay">
                        <a href="{{url($url.'/partnertrip/'.$trip->id)}}"><strong>View More</strong></a>
                    </ul>
                </div>
                <div class="card-body">
                    <h2 class="fas fa-map-marked-alt">{{$trip->name}}</h2>
                </div>
            </div>
        </div>
        @endforeach
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card text-center card-product">
                <div class="card-product__img" >
                    ...
                    @endforeach
                    <ul class="card-product__imgOverlay">
                        <a href="{{url($url.'/usertrip/'.$trip->id)}}"><strong>View More</strong></a>
                    </ul>
                </div>
                <div class="card-body">
                    <h2 class="fas fa-map-marked-alt">{{$trip->name}}</h2>
